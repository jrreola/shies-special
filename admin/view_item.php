            ...
            <div class="col-7 mx-auto my-3">
              ...
              <h3 class="display-3">
                  <a href="?viewitem=2" class="btn btn-primary-outline">
                      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" bg-"transparent" class="bi bi-grid-3x3-gap" viewBox="0 0 16 16">
              ...
              <?php
                  ...
                  $item = query($conn, "SELECT i.item_id as item_id,
                           i.item_name as item_name
                           , i.item_file as item_file 
                           , i.date_added as date_added
                           , pr.item_price item_price
                           , i.item_status
                       FROM items i 
                       JOIN price pr ON i.item_id = pr.item_id 
                       WHERE (pr.item_id, pr.price_id) IN ( 
