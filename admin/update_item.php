            ...
            <div class="col-7 mx-auto my-3 text-light">
                ...
                <h1>Update Item</h1>
                    ...
                    <form action="update.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label fw-semibold"  for="item_price">Item Price <br> 
                            <!-- <i class="text-secondary">Note: If you are adjusting a price, make sure to put effectivity date or it will not take effect.</i>  -->
                            </label>
