...
<body class="bg-transparent text-light">
    ...
    <div class="container-fluid bg-transparent text-light">
        ...
        <div class="row z-1">
            <div class="col-7 mx-auto my-3 mt-0">
                ...
                <form action="" method="POST">
                    <div class="input-group mb-3 w-50">
                        ...
                        <?php $items = query($conn, "SELECT i.item_id, p.price_id, c.cat_id, s.size_id, i.item_name, i_price, i.date_added, i.item_file, c.category_name, c.category_description, s.size, p.item_price, c.category_name, c.cat_file, i.item_stats, c.cat_stats
                        FROM price p
                        ...
                        <div class="col-md-3 border border-dark">
                            <div class="product mt-0 ">
                                <img style="border: solid green 2px; max-width: 100%;" src="../img/<?php echo $item['item_file'];?>" alt="<?php echo $item['item_name']; ?>" height="300px">
                                    <div class="overlay">
                                        <div class="caption mx-auto my-3">
                                        <div class="caption">  
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container-fluid bg-transparent">
                                <div class="row">
                                    <?php foreach($items as $item) { ?>
                                        <div class="col-12 mx-auto my-3 text-light">
                                                <div class="mx-auto my-3 bg-transparent">
                                                    <h5 class="card-title "><?php echo $item['item_name']; ?></h5>
                                                    <?php if(isset($item['category_description'])) { ?>
                                                        <p class="card-text"><?php echo $item['category_description']; ?></p>
                                                    <?php } ?>
                                                    <?php
                                                        // Define CURRENCY constant
                                                        define('CURRENCY', 'Php ');
                                                        ?>
                                                    <p class="card-text"><?php echo CURRENCY . number_format($item['item_price'],2); ?></p>
                                                    <a href="#" class="btn btn-primary mx-auto my-3">View Details</a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
                                ...
                                <li class="list-group-item mb-0 pb-0">
                                    <div class="btn-group mb-0">
                                        ...
                                        <?php if($item['item_stats'] == 'A') { ?>
                                            <a title="Deactivate Item" href="?viewitem=2&deacitem=<?php echo $item['item_id'];?>" class="btn btn-outline-success">
                                        ...
                                        if($item['item_stats'] == 'I'){ ?>
                                            <td> <a title="Reactivate item" href="?viewitem=2&reacitem=<?php echo $item['item_id'];?>" class="btn btn-outline-danger ">
                                    ...
                                    <div class="float-right text-center mt-0 mb-0">
                                            
                                            <?php  
                                            $active = "Active";
                                            $inactive = "Discontinued";
                                            echo "<span title='". ($item['item_stats']=='A'? 'Active' : 'Discontinued')  ."'>" . ($item['item_stats']=='A'? $active :$inactive) . "</span>"; ?>
