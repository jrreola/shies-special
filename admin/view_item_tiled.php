    ...
    <div class="container-fluid bg-transparent text-light">
        ...
        <div class="row z-1">
            <div class="col-7 mx-auto my-3 mt-0">
                ...
                <?php $items = query($conn, "SELECT i.item_id as item_id
                                                , i.item_name as item_name
                                                , i.item_file as item_file
                                            ...
                                            WHERE (p.item_id, p.price_id) in (
                                                    SELECT item_id, max(price_id) as price_id FROM `price` group by item_id
                                                       )
